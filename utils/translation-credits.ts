...
import { LanguageConfig } from '../resources/js/model/language-config';
...
import { normalizeCredit, NormalizedCredits } from '../resources/js/utils/translation';

dotenvConfig();

const markerString = '### Credits';
// @ts-expect-error Not an issue for this script
