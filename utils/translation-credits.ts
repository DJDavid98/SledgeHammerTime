...
import localeConfig from '../lang/config.json' assert { type: 'json' };
import { LanguageConfig } from '../resources/js/model/language-config.js';
import { normalizeCredit, NormalizedCredits } from '../resources/js/utils/translation.js';
...
void (async () => {
	...
	const sortedConfigs: LanguageConfig[] = (Object.values(localeConfig.languages) as LanguageConfig[]).sort((c1, c2) => c1.name.localeCompare(c2.name));
